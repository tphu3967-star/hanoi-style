...
export const shops = [
  { id: 'may-studio', name: 'Mây Studio', category: 'Váy & đầm', description: 'Nàng thơ hiện đại, nhẹ nhàng nhưng luôn có điểm nhấn.', address: '42 Nhà Chung, Hoàn Kiếm, Hà Nội', phone: '098 765 4321', distance: '0,8 km', priceRange: '350K – 1,2M', rating: '4,9', reviews: 128, verified: true, coordinates: { lat: 21.0287, lng: 105.8498 }, image: sampleImage('photo-1496747611176-843222e1e57c'), imageAlt: 'Trang phục nữ tông be trong studio', accent: 'beige' },
  { id: 'nang-tho', name: 'Nàng Thơ', category: 'Đồ công sở', description: 'Đi làm thanh lịch, đi chơi vẫn thật là mình.', address: '18 Trần Quốc Toản, Hoàn Kiếm, Hà Nội', phone: '091 234 5678', distance: '1,4 km', priceRange: '280K – 890K', rating: '4,8', reviews: 96, verified: true, coordinates: { lat: 21.0197, lng: 105.8492 }, image: sampleImage('photo-1551488831-00ddcb6c6bd3'), imageAlt: 'Các mẫu áo và chân váy thời trang nữ', accent: 'lilac' },
  { id: 'tiem-nha-bom', name: 'Tiệm Nhà Bơm', category: 'Áo kiểu', description: 'Những món đồ nhỏ xinh cho ngày thường thêm vui.', address: '7 Ngõ Tràng Tiền, Hoàn Kiếm, Hà Nội', phone: '097 556 7788', distance: '2,1 km', priceRange: '190K – 650K', rating: '4,7', reviews: 74, verified: true, coordinates: { lat: 21.0255, lng: 105.8552 }, image: sampleImage('photo-1506629905607-d9ccf2a6e6a6'), imageAlt: 'Nữ người mẫu mặc áo kiểu sáng màu', accent: 'blue' },
  { id: 'mot-nua', name: 'Một Nửa', category: 'Quần', description: 'Phom dáng thoải mái cho nhịp sống thành thị.', address: '31 Đặng Văn Ngữ, Đống Đa, Hà Nội', phone: '096 312 4567', distance: '3,6 km', priceRange: '320K – 980K', rating: '4,8', reviews: 61, verified: true, coordinates: { lat: 21.0162, lng: 105.8246 }, image: sampleImage('photo-1483985988355-763728e1935b'), imageAlt: 'Không gian shop thời trang nữ hiện đại', accent: 'rose' },
  { id: 'hiem-studio', name: 'Hiên Studio', category: 'Phụ kiện', description: 'Phụ kiện thủ công làm mềm mọi bộ đồ.', address: '12 Xuân Diệu, Tây Hồ, Hà Nội', phone: '090 818 2020', distance: '4,8 km', priceRange: '150K – 780K', rating: '4,9', reviews: 43, verified: true, coordinates: { lat: 21.0618, lng: 105.8235 }, image: sampleImage('photo-1529139574466-a303027c1d8b'), imageAlt: 'Phụ kiện và trang phục nữ được sắp đặt', accent: 'gold' },
  { id: 'gom-fashion', name: 'Gốm Fashion', category: 'Váy & đầm', description: 'Chất liệu tự nhiên, bảng màu lấy cảm hứng từ phố cũ.', address: '88 Hàng Gai, Hoàn Kiếm, Hà Nội', phone: '093 420 6868', distance: '1,1 km', priceRange: '450K – 1,5M', rating: '4,6', reviews: 38, verified: true, coordinates: { lat: 21.0339, lng: 105.8493 }, image: sampleImage('photo-1515886657613-9f3515b0c78f'), imageAlt: 'Trang phục nữ phong cách tối giản', accent: 'terracotta' },
]
