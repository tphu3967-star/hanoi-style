...
function App() {
  ...
  const visibleProducts = useMemo(() => catalog.products.filter((product) => {
    ...
    const matchesDistrict = activeDistrict === 'Tất cả khu vực' || getShopDistrict(shop) === activeDistrict
    return matchesShop && matchesCategory && matchesProvince && (activeProvince === 'Hà Nội' ? matchesDistrict : true) && matchesSearch
  }), [catalog.products, shopsById, selectedShop, activeCategory, activeDistrict, activeProvince, query])
